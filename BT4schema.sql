...
/****** Object:  Database [QL_TKB]    Script Date: 4/14/2025 6:36:12 PM ******/
CREATE DATABASE [QL_TKB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QL_TKB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.THANTHANH\MSSQL\DATA\QL_TKB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'QL_TKB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.THANTHANH\MSSQL\DATA\QL_TKB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [QL_TKB] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [QL_TKB] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [QL_TKB] SET RECOVERY SIMPLE 
GO
